...
class MimeMailParserAttachment {
        ...
        public function __construct($filename, $content_type, $stream, $content_disposition = 'attachment', $headers = array(),$log) {
               
            fwrite($log, " cccccccccccccc \n");  
