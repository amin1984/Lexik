 ...
 * Customer
 *
 * @ORM\Table(name="satisfactory_customer")
 * @ORM\Entity(repositoryClass="Satisfactory\SettingBundle\Repository\CustomerRepository")
 */
class Customer {
    ...
    public function checkFile() {
        ...
        if ( $tab[1] == 'csv' ) {
            ...
            if ($separator == ";") {
                ...
                if ($line[0] == "id_utilisateur;nom_utlisateur;id_groupe") {
                    $path = 'uploads/settings/users';
