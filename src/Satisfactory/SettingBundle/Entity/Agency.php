 ...
 * Agency
 *
 * @ORM\Table(name="satisfactory_agency")
...
class Agency {
    ...
    protected function getUploadDir() {
        ...
        return 'uploads/settings/agency';
    }
    ...
    public function checkFile() {
        ...
        if ( $tab[1] == 'csv' ) {
            ...
            if ($separator == ";") {
                ...
                if ($line[0] == "id_agence;nom_agence") {
                    $path = 'uploads/settings/agency';
                    ...
                    if (!$redundancy) {
                        ...
                        return 'Le fichier contient un doublon sur la base de "id_agence" !';
                    }
                } else {
