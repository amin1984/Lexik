 ...
 * AgencySegment
 *
 * @ORM\Table(name="satisfactory_agency_segment")
 * @ORM\Entity(repositoryClass="Satisfactory\SettingBundle\Repository\AgencySegmentRepository")
 */
class AgencySegment {
    ...
    protected function getUploadDir() {
        ...
        return 'uploads/settings/agency_segment';
    }
    ...
    public function checkFile() {
        ...
        if ( $tab[1] == 'csv' ) {
            ...
            if ($separator == ";") {
                ...
                if ($line[0] == "id_agence;id_segment") {
                    $path = 'uploads/settings/agency_segment';
