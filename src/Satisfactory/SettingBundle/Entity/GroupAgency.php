 ...
 * GroupAgency
 *
 * @ORM\Table(name="satisfactory_group_agency")
 * @ORM\Entity(repositoryClass="Satisfactory\SettingBundle\Repository\GroupAgencyRepository")
 */
class GroupAgency {
    ...
    protected function getUploadDir() {
        ...
        return 'uploads/settings/agency_group';
    }
    ...
    public function checkFile() {
        ...
        if ( $tab[1] == 'csv' ) {
            ...
            if ($separator == ";") {
                ...
                if ($line[0] == "id_groupe;id_agence") {
                    $path = 'uploads/settings/agency_group';
